...
The diagram below shows how ERC-8183 job actions flow through AgentCourt and write to the ERC-8004 reputation registry at each stage.

![AgentCourt Contract Flow & Data Dependencies](/images/agentcourt_contract_flow.svg)
