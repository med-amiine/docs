...
There are two distinct decision-making roles in Jurex — understanding this separation is key to how appeals work.

![Evaluator vs. Judge: Clear Role Separation](/images/evaluator_vs_judge_roles.svg)
